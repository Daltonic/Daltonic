...
<div class="video-grid" style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 20px;"><div class="video-card" style="width: 200px; border: 1px solid lightgray; border-radius: 10px; overflow: hidden;"><a href="https://www.youtube.com/watch?v=jAZ47qKwJc0"><img src="https://img.youtube.com/vi/jAZ47qKwJc0/0.jpg" alt="Hackathon Project Demo: Alephium Blockchain" width="200"/><p style="word-wrap: break-word; max-width: 100%; padding: 0 10px;">Hackathon Project Demo: Alephium Blockchain</p></a></div>
