...
<div class="video-grid" style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 20px;"><div class="video-card" style="width: 200px; border: 1px solid lightgray; border-radius: 10px; overflow: hidden;"><a href="https://www.youtube.com/watch?v=6-Dm7uyUUXU"><img src="https://img.youtube.com/vi/6-Dm7uyUUXU/0.jpg" alt="Build an AI-Powered Payroll DApp on Solana (Rust + Next.js + LLMs + MCP)" width="200"/><p style="word-wrap: break-word; max-width: 100%; padding: 0 10px;">Build an AI-Powered Payroll DApp on Solana (Rust + Next.js + LLMs + MCP)</p></a></div>
